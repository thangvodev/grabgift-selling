...
import { WarrantyActivationSuccessPageProductDetails } from "../components/WarrantyActivationSuccessPage";

const WarrantyActivationSuccessPage = () => {
  return (
    <Page className="page-content relative flex flex-1 flex-col bg-white">
      ...
      <div className="flex-1 overflow-auto py-[16px] hide-scrollbar">
        <WarrantyActivationSuccessPageProductDetails />
      </div>
    </Page>
  );
};

export default WarrantyActivationSuccessPage;
