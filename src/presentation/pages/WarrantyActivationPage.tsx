...
import { WarrantyActivationPageActivationSteps } from "../components/WarrantyActivationPage";
...
const WarrantyActivationPage = () => {
  return (
    <Page className="page-content relative flex flex-1 flex-col bg-white">
      ...
      />
      <div className="flex-1 overflow-auto px-[16px] hide-scrollbar">
        <WarrantyActivationPageActivationSteps />
      </div>
    </Page>
  );
};
