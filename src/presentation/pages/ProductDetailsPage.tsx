...
import { ProductDetailsPageProductDetails } from "../components/ProductDetailsPage";
...
const ProductDetailsPage = () => {
  return (
    <Page className="page-content relative flex flex-1 flex-col bg-white">
      ...
      />
      <div className="productspage-scroll-container flex-1 overflow-auto bg-white hide-scrollbar">
        <ProductDetailsPageProductDetails />
      </div>
    </Page>
  );
};
