...
import { ProductOrderPageOrderForm } from "../components/ProductOrderPage";
...
const ProductOrderPage = () => {
  return (
    <Page className="page-content relative flex flex-1 flex-col bg-white">
      ...
      />
      <div className="flex-1 overflow-auto bg-surface p-[16px] hide-scrollbar">
        <ProductOrderPageOrderForm />
      </div>
    </Page>
  );
};
