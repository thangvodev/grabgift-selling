      ...
      >
        <>
          ...
          <div className="flex flex-col items-center gap-[12px] pb-[49px] pt-[30px]">
            ...
            <Button
              text={
                <span className="text-sm font-medium text-white">Nhận quà</span>
              }
              className="flex h-[42px] w-[171px] flex-none items-center justify-center rounded-[40px]"
              style={{
                boxShadow: "0px 8px 20px 0px #BA000040",
                background: "linear-gradient(180deg, #E4A231 0%, #FF7B7B 100%)",
    ...
    return (
      <div className="flex flex-col items-center gap-[20px]">
        <div className="-mt-[10px] text-xs font-medium text-neutral8">
          Vui lòng chọn <span className="text-sm font-bold text-error3">1</span>{" "}
          món quà.
        </div>
        <Form form={form}>
    ...
    return (
      <div className="flex flex-col items-center gap-[20px]">
        <div className="-mt-[10px] text-xs font-medium text-neutral8">
          ...
          <span className="text-sm font-bold text-error3">2</span> món quà.
        </div>
